...
var ASM_CONSTS = {
  4449932: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4449987: ($0) => { performance.now = function() { return $0; }; },  
 4450035: ($0) => { performance.now = function() { return $0; }; },  
 4450083: () => { performance.now = Module['emscripten_get_now_backup']; }
};
