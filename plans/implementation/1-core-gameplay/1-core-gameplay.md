...
1.7에서 기존 구현 점검과 모듈·전투 그리드 재설계를 함께 수행한다. 실제 실행 순서는 `1.7(재설계 포함) → 1.8 → 99 → 100`이다.
...
1. [1.1-playable-loop.md](1.1-playable-loop.md) - 한 지역을 끝까지 플레이할 수 있는 루프
2. [1.2-module-foundation.md](1.2-module-foundation.md) - 모듈 공통 상태와 격자 기반
3. [1.3-combat-mvp.md](1.3-combat-mvp.md) - 직사·곡사 전투의 최소 규칙
4. [1.4-resource-collection.md](1.4-resource-collection.md) - 자원 획득과 저장
5. [1.5-production-and-logistics.md](1.5-production-and-logistics.md) - 자원 가공, 탄약, 운송
6. [1.6-mobility-defense.md](1.6-mobility-defense.md) - 기동 모듈과 방어 판정
7. [1.7-mid-term-review.md](1.7-mid-term-review.md) - 기존 구현 점검과 모듈·전투 그리드 재설계
8. [1.8-progression-content.md](1.8-progression-content.md) - 탱크 콘텐츠, 적, 지역·행성 진행
99. [99-ui-tutorial.md](../99-ui-tutorial/99-ui-tutorial.md) - 업그레이드 그래프 튜토리얼과 사용자 경험
100. [100-release-verification.md](../100-release-verification/100-release-verification.md) - 새 구조 기준 밸런스와 배포 전 검증
