...
- [x] 2.2.2 imagegen: `tank.module.direct-weapon`, `tank.module.arc-weapon`을 생성하고 투명 bounds crop, padding, nearest-neighbor 정규화를 적용했다.
...
- [x] 2.2.3 provenance: 생성 원본, 폐기된 direct weapon 시도, prompt set, 정규화 규칙, runtime 파일 목록을 `docs/art-asset-provenance.md`에 기록했다.
