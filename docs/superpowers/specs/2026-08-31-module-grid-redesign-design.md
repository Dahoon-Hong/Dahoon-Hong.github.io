...
- `plans/implementation/1-core-gameplay/1.8-progression-content.md`: 기존 일반 모듈·코어 레벨 업 계획을 새 트리 데이터 계획으로 갱신
- `plans/implementation/99-ui-tutorial/99-ui-tutorial.md`: 하단 상점 전제와 단일 업그레이드 버튼을 제거하고 그래프 UI 튜토리얼로 갱신
